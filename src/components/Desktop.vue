...
<template>
  <div>
    <div><a style="color: var(--h1-color)" v-on:click="store.checkPlaylists()"
            href="#modal1">{{ store.queue }}</a></div>
    <ul class="tabs">
      <li id="option1">
        <a id="playlistlist" v-on:click="store.switchTabs({event:$event})"
      ...
      <li id="option2">
        <a id="ta"
           v-on:click="store.switchTabs({event:$event}),store.switchArtist({num:1})"
        ...
        <div>
          ...
          <div id="topartist6" class="con2" style="display: flex;color: black;width: auto;">
            <div class="trackbody" v-for="(item,index) of store.topartist6" v-bind:key="index">
              <div v-if="item.preview_url" tabindex="0" class="con3"
          ...
          <div id="topartista" class="con2" style="display: flex;color: black;width: auto;">
            <template v-for="(item,index) of store.topartista">
              <div v-if="item.preview_url" tabindex="0" v-bind:key="index" class="con3"
      ...
      <!--        </li>-->
      <li id="option3">
        <a v-on:click="store.switchTabs({event:$event}),store.switchTracks({num:1})"
        ...
        <div>
          ...
          <div id="toptrack6" class="con2" style="display: flex;color: black;width: auto;">
            <div class="trackbody" v-for="(item,index) of store.itemsm" v-bind:key="index">
              <div v-if="item.preview_url" tabindex="0" class="con3"
                   v-on:mouseover="store.mouseOver($event)"
                   v-on:mouseleave="store.mouseLeave($event)"
          ...
          <div id="toptrackall" class="con2" style="display: flex;color: black;width: auto;">
            <div class="trackbody" v-for="(item,index) of store.itemsl" v-bind:key="index">
              <div v-if="item.preview_url" tabindex="0" class="con3"
                   v-on:mouseover="store.mouseOver($event)"
                   v-on:mouseleave="store.mouseLeave($event)"
      ...
      <!--        </li>-->
      <li id="option4">
        <a v-on:click="store.switchTabs({event:$event})" id="sa"
           v-on:click.self.once="store.fetchAlbums({offset:0,event:$event})">Saved albums</a>
        <div>
          <div id="savedalbum" class="con2">
            <div class="albumbody" v-for="(item,index) of store.savedalbums" v-bind:key="index">
      ...
      <li id="option5">
        <a v-on:click="store.switchTabs({event:$event})" id="st"
           v-on:click.self.once="store.fetchTracks({offset:0})">Saved tracks</a>
        <div>
          <div id="savedtrack" class="con2">
            <div class="albumbody" v-for="(item,index) of store.savedtracks" v-bind:key="index">
      ...
      <li id="option6">
        <a v-on:click="store.switchTabs({event:$event})" id="fa"
        ...
        <div>
          ...
          <div id="followedartist" style="width: 95%;" class="con2">
            <div class="fabody" v-for="(item,index) of store.followedartists" v-bind:key="index">
              <div v-if="item.preview_url" tabindex="0" class="con3"
                   v-on:mouseover="store.mouseOver($event)"
                   v-on:mouseleave="store.mouseLeave($event)"
      ...
      <li id="option7">
        <a v-on:click="store.switchTabs({event:$event})" id="nr"
           v-on:click.self.once="store.fetchNR({offset:0})">New releases</a>
        <div style="display: block;width: 95%">
          <div id="newrelease" class="con2">
            <div class="newbody" v-for="(item,index) of store.newreleases" v-bind:key="index">
      ...
      <li id="option8">
        <a v-on:click="store.switchTabs({event:$event})" id="spt"
      ...
      <li id="srch" class="srch"><a id="sear" style="padding: 15px;"><input type="search" class="inp"
                                                                            v-on:keyup="store.search($event)"></a>
      ...
      <div class="modal" id="modal1">
        ...
        <div class="modal__content">
          ...
          <div style="display: flex;">
            ...
            <div v-on:click="store.removequeue()">Clear all</div>
          </div>
          <div style="height: 250px;overflow-y: auto;margin-top: 10px;">
            <div v-for="(q,index) in store.queuearr" class="playable-search" style="color: var(--con2-color)" v-bind:key="index">
              ...
              <div style="margin-left: auto;" v-on:click="store.removequeueitem(q.id)">Clear</div>
            </div>
          </div>
