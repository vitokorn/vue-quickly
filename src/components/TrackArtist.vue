...
<template>
  ...
  >
    ...
    <div v-if="artistData" class="artist-section">
      <div class="deeper-header">
        ...
        <div :class="['artist-cover', getMediaDisplay(artistData).displayClass.value]"
          ...
          <audio :preload="getMediaDisplay(artistData).audioPreload.value" :src="getMediaDisplay(artistData).audioSrc.value"></audio>
        </div>
          ...
          <div class="genres-section" v-if="artistData.genres && artistData.genres.length > 0">
            <div class="gnr-list">
              <template v-for="(g, gIndex) in artistData.genres" :key="'genre-'+gIndex">
                <span v-if="artistData.genres.length > 1 && artistData.genres.length - 1 === gIndex" class="separator">&</span>
                <span v-if="artistData.genres.length >= 2 && artistData.genres.length - 1 !== gIndex && gIndex !== 0" class="separator">,</span>
    ...
    <!-- Top Tracks Section -->
    <div v-if="topTracksData.length > 0" class="section-header">
    ...
    <!-- Albums Section -->
    <div v-if="albumsData.length > 0" class="section-header">
    ...
    <!-- Singles Section -->
    <div v-if="singlesData.length > 0" class="section-header">
    ...
    <!-- Appears On Section -->
    <div v-if="appearsOnData.length > 0" class="section-header">
    ...
    <div v-if="relatedArtistsData.length > 0" class="section-header">
